...
/client/verb/adminhelp(msg as text)
	...
	*/
	...
	if(admin_number_active <= 0)
		discord_bot.send_to_admins("@here Request for Help from [key_name(src)]: [rhtml_decode(original_msg)] - !![admin_number_afk ? "All admins AFK ([admin_number_afk])" : "No admins online"]!!")
		adminhelped = 3
