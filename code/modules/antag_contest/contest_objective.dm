...
/datum/objective/competition/proc/log_result()
	...
	var/DBQuery/get_query = dbcon.NewQuery("SELECT contest_faction FROM erro_contest_participants WHERE player_ckey = :ckey: AND character_id = :char_id:")
	...
	var/DBQuery/log_query = dbcon.NewQuery("INSERT INTO erro_contest_reports (id, player_ckey, character_id, character_faction, objective_type, objective_side, objective_outcome, objective_datetime) VALUES (NULL, :ckey:, :char_id:, :char_faction:, :obj_type:, :obj_side:, :obj_outcome:, NOW())")
